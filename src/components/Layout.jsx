            ...
            >
                <Masonry>
                    <div className="tagMessage">
                        <div className=" relative w-[75%] justify-center items-center m-8 p-4 bg-amber-100/75 text-black rounded-[25px] border-4 border-amber-300  ">
                            <span className='text-xs inline '>Hà Mi 5:00 20/01/2024</span>
                            <button className='float-right inline text-xs '><FaEllipsisV /></button>
                            <p className='block mt-4 mb-10 font-semibold' >Chúc mừng năm mới, hy vọng rằng những ngày i sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuytới sẽ đem lại nhiều điều tuyệt vời và hạnh phúc cho bạn và gia đình!</p>
                    ...
                    <div className="tagMessage">
                        <div className=" relative w-[75%] justify-center items-center m-8 p-4 bg-amber-100/75 text-black rounded-[25px] border-4 border-amber-300  ">
                            <span className='text-xs inline '>Hà Mi 5:00 20/01/2024</span>
                            <button className='float-right inline text-xs '><FaEllipsisV /></button>
                            <p className='block mt-4 mb-10 font-semibold' >Năm mới đến, hãy bước vào cuộc sống mới với tâm hồn lạc quan và tràn đầy năng lượng tíci sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyh cực.</p>
                            <div className="absolute bottom-4 right-8 ">
                    ...
                    <div className="tagMessage">
                        <div className=" relative w-[75%] justify-center items-center m-8 p-4 bg-amber-100/75 text-black rounded-[25px] border-4 border-amber-300  ">
                            <span className='text-xs inline '>Hà Mi 5:00 20/01/2024</span>
                            <button className='float-right inline text-xs '><FaEllipsisV /></button>
                            <p className='block mt-4 mb-10 font-semibold' >Chúc bạn và những người thân yêu có một năm mới an lành, tràni sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuy đầy tình thương và đong đầy niềm vui.</p>
                            <div className="absolute bottom-4 right-8 ">
                    ...
                    <div className="tagMessage">
                        <div className=" relative w-[75%] justify-center items-center m-8 p-4 bg-amber-100/75 text-black rounded-[25px] border-4 border-amber-300  ">
                            <span className='text-xs inline '>Hà Mi 5:00 20/01/2024</span>
                            <button className='float-right inline text-xs '><FaEllipsisV /></button>
                            <p className='block mt-4 mb-10 font-semibold' >Năm mới là dịp để bạn thực hiện những bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn bạn thực hiện nhữn ước mơ lể bạn thực hiện nhữnể bạn thực hiện nhữnể bạn thực hiện nhữnể bạn thực hiện nhữnớn, bắt đầu những dự định mới và khám phá những khả năng mới trong bản thân.</p>
                            <div className="absolute bottom-4 right-8 ">
                    ...
                    <div className="tagMessage">
                        <div className=" relative w-[75%] justify-center items-center m-8 p-4 bg-amber-100/75 text-black rounded-[25px] border-4 border-amber-300  ">
                            <span className='text-xs inline '>Hà Mi 5:00 20/01/2024</span>
                            <button className='float-right inline text-xs '><FaEllipsisV /></button>
                            <p className='block mt-4 mb-10 font-semibold' >Mỗi giọt nước mưa là một hạt may, chúc bạn có một năm mới tràn đầy những hạt may may mắn và thành công không ngừng.</p>
                            <div className="absolute bottom-4 right-8 ">
                    ...
                    <div className="tagMessage">
                        <div className=" relative w-[75%] justify-center items-center m-8 p-4 bg-amber-100/75 text-black rounded-[25px] border-4 border-amber-300  ">
                            <span className='text-xs inline '>Hà Mi 5:00 20/01/2024</span>
                            <button className='float-right inline text-xs '><FaEllipsisV /></button>
                            <p className='block mt-4 mb-10 font-semibold' >Năm mới an khang thịnh vượng và tràn đầy năng lượng tich cực. Chúc mừng năm mới nhé !!!</p>
                            <div className="absolute bottom-4 right-8 ">
                    ...
                    <div className="tagMessage">
                        <div className=" relative w-[75%] justify-center items-center m-8 p-4 bg-amber-100/75 text-black rounded-[25px] border-4 border-amber-300  ">
                            <span className='text-xs inline '>Hà Mi 5:00 20/01/2024</span>
                            <button className='float-right inline text-xs '><FaEllipsisV /></button>
                            <p className='block mt-4 mb-10 font-semibold' >Năm mới, hãy để những điều tốt đẹp nhất đến với bạn và mọi người xung quanh bạn.</p>
                            <div className="absolute bottom-4 right-8 ">
                    ...
                    <div className="tagMessage">
                        <div className=" relative w-[75%] justify-center items-center m-8 p-4 bg-amber-100/75 text-black rounded-[25px] border-4 border-amber-300  ">
                            <span className='text-xs inline '>Hà Mi 5:00 20/01/2024</span>
                            <button className='float-right inline text-xs '><FaEllipsisV /></button>
                            <p className='block mt-4 mb-10 font-semibold' >Năm mới đến, hãy giữ cho tâm hồn bại sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyi sẽ đem lại nhiều điều tuyn luôn trẻ trung và hãy tin rằng mọi đg mọi điều tốt lành sẽ đến với bg mọi điều tốt lành sẽ đến với bg mọi điều tốt lành sẽ đến với biều tốt lành sẽ đến với bạn.</p>
                            <div className="absolute bottom-4 right-8 ">
