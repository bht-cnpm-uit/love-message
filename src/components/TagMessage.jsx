...
const TagMessage = ({
    ...
    return (
        <div
            className={`${
                data.id === currentBigTag.id &&
                (isShowBigTag || isOpenDeleteMessage || isOpenUpdateMessage)
                    ? 'opacity-0'
                    : ''
            } tagMessage font-mono align-bottom hover:cursor-pointer transition hover:-translate-y-1`}
        ...
        >
            ...
            >
                ...
                <LinesEllipsis
                    text={data.message}
                    className="break-all text-pretty mt-4 mb-14 font-bold"
                    maxLine={5}
                    ellipsis="..."
                />
                ...
                <div className={`flex flex-row-reverse absolute bottom-0 w-full right-8`}>
                    ...
                    <div
                        className={`${
                            onHover ? '' : 'hidden'
                        } ml-3 flex flex-col justify-center items-center`}
                        onClick={(e) => {
                            e.stopPropagation();
