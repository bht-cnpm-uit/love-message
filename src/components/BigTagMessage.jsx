                        ...
                        <form className="space-y-4">
                            <div className="mb-4">
                                <div className="relative">
                                    <p
                                        className="w-full border-b-2 text-center border-gray-300 py-2 px-3 text-gray-700 leading-tight"
                            ...
                            <div className="mb-4">
                                <div className="relative">
                                    <p
                                        className="w-full border-b-2 border-gray-300 py-2 px-4 text-gray-700 leading-tight"
                                        id="message"
                                        style={{ fontFamily: 'Dancing Script' }}
                                    >
                                        {data.message}
